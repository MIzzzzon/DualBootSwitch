...
extern "C" jint Java_com_pexcn_dualbootswitch_CallNative_setBootmode(JNIEnv * env, jobject thiz, jstring jBootmode) {
	jboolean isCopy;
...
extern "C" jstring Java_com_pexcn_dualbootswitch_CallNative_getBootmode(
